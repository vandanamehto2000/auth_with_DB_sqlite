...
createDB.sync().then(() => { //Sync all defined models to the DB
...
router.post("/signup", async (req, res) => {
    try {
        ...
        const userExist = await User.findOne({where: {email}}) //check if the user with the entered email already exists in the database
